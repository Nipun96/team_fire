...
{
    public partial class sup_ratings : UserControl
    {

        private static sup_ratings _instance;
        public static sup_ratings Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new sup_ratings();
                return _instance;
            }
        }
        ...
        private void bunifuCustomDataGrid1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string num1 = db.dbgett("SELECT COUNT(Sell_confrm)FROM add_product a ,product p WHERE a.Pro_Id=p.Pro_Id AND Sell_confrm=1 AND Sup_Id='" + Search.Text + "'");
            string num2 = db.dbgett("SELECT COUNT(Sell_confrm)FROM add_product a ,product p WHERE a.Pro_Id=p.Pro_Id AND Sup_Id='" + Search.Text + "'");
       ...
       // int num2;
        ...
        public void LoadChart()
        {
            try
            {
                ...
                this.chart1.Series.Add("Unit Price");
                string query = "SELECT Date ,Quantity ,UnitPrice FROM product";
                ...
                while (myReader.Read())
                {
                    ...
                    this.chart1.Series["Unit Price"].Points.AddXY(myReader.GetString("Date"), myReader.GetString("UnitPrice"));
                }
