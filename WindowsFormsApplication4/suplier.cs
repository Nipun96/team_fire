...
namespace WindowsFormsApplication4
{
    public partial class suplier : UserControl
    {
        ...
        {
            if (!panel1.Controls.Contains(sup_custom.Instance))
            {
                panel1.Controls.Add(sup_custom.Instance);
                sup_custom.Instance.Dock = DockStyle.Fill;
                sup_custom.Instance.BringToFront();
            }
            else
                sup_custom.Instance.BringToFront();
            sup_custom.Instance.Visible = true;
        ...
        {
            if (!panel1.Controls.Contains(sup_View.Instance))
            {
                panel1.Controls.Add(sup_View.Instance);
                sup_View.Instance.Dock = DockStyle.Fill;
                sup_View.Instance.BringToFront();
            }
            else
                sup_View.Instance.BringToFront();
            sup_View.Instance.Visible = true;

        }

        private void button1_Click(object sender, EventArgs e)
        {
            if (bunifuMaterialTextbox1.Text != "" && bunifuMaterialTextbox2.Text != "" && bunifuMaterialTextbox3.Text != "" && bunifuMaterialTextbox4.Text != "" && bunifuMaterialTextbox5.Text != "" && bunifuMaterialTextbox6.Text != "" && bunifuMaterialTextbox7.Text != "" && bunifuMaterialTextbox8.Text != "" && bunifuMaterialTextbox9.Text != "")
            {
                try
                {
                    Database db = new Database();
                    string qu = " insert into supplier (Sup_Id,Company_Name,Name,Region,Country,City,Address,E_Mail,Telephone) values('" + bunifuMaterialTextbox1.Text + "', '" + bunifuMaterialTextbox2.Text + "', '" + bunifuMaterialTextbox3.Text + "', '" + bunifuMaterialTextbox4.Text + "','" + bunifuMaterialTextbox5.Text + "', '" + bunifuMaterialTextbox6.Text + "', '" + bunifuMaterialTextbox7.Text + "', '" + bunifuMaterialTextbox8.Text + "', '" + bunifuMaterialTextbox9.Text + "')";
                    db.DBhand(qu);
                }
        ...
        private void bunifuMaterialTextbox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((bunifuMaterialTextbox1.Text.Length == 5) && (e.KeyChar != '.') && (e.KeyChar != 46) && (e.KeyChar != 8))
            {
                e.Handled = true;
            }
        }
